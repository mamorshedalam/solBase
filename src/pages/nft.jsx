...
import sub4Img from "../assets/member/Picture4.png";
          ...
          <main className="bg-gradient-to-t from-slate-950 via-purple-500 to-slate-950">
               ...
               <section className="md:pb-20 pb-10 md:-mt-20 -mt-16">
                    <div className="sl-container md:pb-20 pb-10">
                         <div className="wow fadeInUp flex flex-wrap border border-white/10 rounded-lg">
                              <div className="md:w-64 w-full"><img src={sub4Img} alt="" className="w-full h-full object-cover rounded-t-lg md:rounded-tr-none" /></div>
                    ...
                    <p className="wow fadeIn text-center capitalize text-lg font-medium">This Page Will Be Updated With More info <span className="text-amber-500">prior</span> to launching our pools <span className="block text-2xl">Stay tuned</span></p>
               </section>
          </main>
     )
}