               ...
               <section className="md:pb-20 pb-10 md:-mt-20 -mt-16">
                    <div className="sl-container">
                         ...
                         <div className="wow fadeInLeft flex flex-wrap w-full md:border border-white/10 rounded-b-lg">
                              <div className="md:order-1 order-2 flex flex-col justify-center lg:px-20 sm:px-10 py-10 px-5 md:w-2/5 bg-slate-950 rounded-b-lg md:rounded-r-none">
                                   ...
                                   <Link to={`/copy-trading`} className="w-fit bg-sky-700 border-2 border-sky-700 px-6 sm:py-3 py-2 rounded-lg hover:bg-slate-950">Learn More</Link>
                              </div>
                              <div className="md:order-2 order-1 flex items-center text-center md:w-3/5 w-full sm:py-20 lg:px-20 sm:px-10 py-10 px-5 border-r border-white/10 md:min-h-[600px] min-h-[280px] bg-fixed bg-cover bg-no-repeat bg-center md:rounded-br-lg" style={{ backgroundImage: `url(${neuImg})` }}>
