     ...
     return (
          <main className="bg-gradient-to-t from-slate-950 via-purple-500 to-slate-950">
               ...
               <section className="md:pb-20 pb-10 md:-mt-20 -mt-16 px-2">
                    <div className="max-w-3xl mx-auto text-center border border-white/10 rounded-lg bg-neutral-900/75 backdrop-blur-lg shadow-lg shadow-neutral-900/15 sm:py-20 lg:px-20 sm:px-10 py-10 px-5 ">
                         ...
                         <a href="" className="bg-gradient-to-r from-amber-500 to-amber-400 text-slate-950 py-2 px-6 rounded-lg font-semibold hover:text-white">Mail Us</a>
                    </div>
               </section>
          </main>
     )
